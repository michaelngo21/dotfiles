  ...
  opts = {
    ...
    options = {
      opt = { -- vim.opt.<key>
        ...
        scrolloff = 0, -- number of lines to keep above/below cursor when scrolling
      },
      g = { -- vim.g.<key>
    ...
    mappings = {
      ...
      n = {
        ...
        -- move cursor without scrolling viewport
        ["<C-d>"] = {
          function()
            local move = math.floor(vim.fn.winheight(0) / 2)
            vim.cmd("normal! " .. move .. "j")
          end,
